  ...
  root((🏥 MedSort))
    ...
    📋 Картки поранених
      Створення картки
        ...
        Домедична допомога
      Журнал поранених
        Пошук за ПІБ / позивним
        Фільтрація за тріажем та статусом
        Пагінація
      Редагування картки
      Зміна статусу
        active
    ...
    🏥 Маршрутизація
      Перегляд лікарень
      Рекомендація лікарні
        Оцінка за відстанню
        Оцінка за місткістю
        Оцінка за спеціалізацією
      Призначення лікарні
      Оновлення завантаженості
    🛠️ Управління лікарнями
      Додавання лікарні
      Редагування показників
        Місткість та завантаженість
        Спеціалізації
        Контактні дані
        Статус активності
      Видалення лікарні
